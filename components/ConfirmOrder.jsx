              ...
              <View key={`${order.name}-${index}`} style={styles.orderItem}>
                <View style={styles.orderDetails}>
                  <Text style={styles.orderText}>
                    <Text style={styles.fontBold}>x{order.amount}</Text> {order.name}
                  </Text>
                  <Text style={styles.orderPrice}>{(order.amount * order.price)?.toFixed(2)}€</Text>
                </View>
                {order.ingredients && (
                  <Text style={styles.ingredientsText}>({order.ingredients})</Text>
                )}
              </View>
            ))}
          </View>
